...
- Name: visual-checker.spec.js >> Date Time Checker - Visual Regression Tests >> V-02: Verify main window container visual details
- Location: tests\e2e\visual-checker.spec.js:15:3
...
Locator: locator('.window-container')
  Expected an image 440px by 358px, received 440px by 394px. 14337 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: window-container-default.png

Call log:
  - Expect "toHaveScreenshot(window-container-default.png)" with timeout 5000ms
