...
- Name: visual-checker.spec.js >> Date Time Checker - Visual Regression Tests >> V-03: Verify form visual state when inputting data
- Location: tests\e2e\visual-checker.spec.js:21:3
...
Locator: locator('.window-container')
  Expected an image 440px by 354px, received 440px by 390px. 14904 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: window-container-with-inputs.png

Call log:
  - Expect "toHaveScreenshot(window-container-with-inputs.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - waiting for locator('.window-container')
    - locator resolved to <div class="window-container ">…</div>
