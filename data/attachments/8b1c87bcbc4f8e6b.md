...
```
Error: A snapshot doesn't exist at /home/runner/work/dtchecker/dtchecker/tests/e2e/visual-checker.spec.js-snapshots/close-confirm-msgbox-chromium-linux.png, writing actual.
```
...
- generic [ref=e3]:
  ...
  - dialog [ref=e34]:
    - generic [ref=e35]:
      - generic [ref=e36]: Confirm
      - button "Close" [ref=e37] [cursor=pointer]:
        - img [ref=e38]
    - generic [ref=e41]:
      - img [ref=e43]
      - generic [ref=e46]: Are you sure to exit?
    - generic [ref=e47]:
      - button "Yes" [active] [ref=e48] [cursor=pointer]
