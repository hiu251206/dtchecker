...
```
Error: A snapshot doesn't exist at /home/runner/work/dtchecker/dtchecker/tests/e2e/visual-checker.spec.js-snapshots/date-result-correct-msgbox-chromium-linux.png, writing actual.
```
...
- generic [ref=e3]:
  ...
  - dialog [ref=e34]:
    - generic [ref=e35]:
      - generic [ref=e36]: Message
      - button "Close" [ref=e37] [cursor=pointer]:
        - img [ref=e38]
    - generic [ref=e41]:
      - img [ref=e43]
      - generic [ref=e45]: 29/02/2024 is correct date time
    - button "OK" [active] [ref=e47] [cursor=pointer]
```
