...
```
Error: A snapshot doesn't exist at /home/runner/work/dtchecker/dtchecker/tests/e2e/visual-checker.spec.js-snapshots/window-container-with-inputs-chromium-linux.png, writing actual.
```
